		...
		<div class="navbar navbar-fixed-top" role="navigation" data-0="line-height:100px; height:100px; background-color:rgba(0,0,0,0.3);" data-300="line-height:60px; height:60px; background-color:rgba(0,0,0,1);">
			 <div class="container">
				<div class="navbar-header">
					...
					<h1><a class="navbar-brand" href="#" data-0="line-height:90px;" data-300="line-height:50px;">	Salada
					</a></h1>
				</div>
				<div class="navbar-collapse collapse">
					<ul class="nav navbar-nav" data-0="margin-top:20px;" data-300="margin-top:5px;">
						<li class="active"><a href="#">Inici</a></li>						
						<li><a href="#section-works">Catàleg</a></li>
						<li><a href="#section-about">Qui som?</a></li>
						<li><a href="#section-contact">Contacte</a></li>
					</ul>
				</div><!--/.navbar-collapse -->
			</div>
		</div>
				...
				<div class="row mar-bot40">
					<div class="col-md-6 col-md-offset-3">				
						<div class="align-center">
							<i class="fa fa-tags fa-5x mar-bot20"></i>
							<h2 class="slogan">Benvigut! Cerca la millor platja per visitar avui!</h2>
					        <form class="col-lg-12">
					        	<div class="input-group" style="width:340px;text-align:center;margin:0 auto;">
					            <input id='form-cerca' class="form-control input-lg" title="Insereix el nom de la platja o un lloc proper!" placeholder="Quina platja vols consultar?" type="text">
					            <span class="input-group-btn"><button onclick="cercaPlatja()"class="btn btn-lg btn-primary" type="button"><a href="#section-contact">Cerca</button></span>
					            </div>
					        </form>
				        </div>
					</div>
				...
				<div class="row mar-bot40">
					<div class="col-md-offset-3 col-md-6">
						<div class="section-header">
							<h2 class="section-heading animated" data-animation="bounceInUp">Platges de Mallorca</h2>
							<p>Un carro carregat de terra rotja i no men record de res més</p>
						</div>
					</div>
				</div>
                        ...
                        <div class="row">
                          <nav id="filter" class="col-md-12 text-center">
                            <ul>
                              ...
                              <li ><a href="#" class="btn-theme btn-small" >Prova</a></li>
                            </ul>
                          </nav>
                          <div class="col-md-12">
                            <div class="row">
			...
			<div class="row animated opacity mar-bot20" data-andown="fadeIn" data-animation="animation">
				<div class="col-sm-12 align-center">
                    <ul class="social-network social-circle">
                        ...
                        <li><a href="http://youtube.com" target="_blank" class="icoYoutube" title="Youtube"><i class="fa fa-youtube"></i></a></li>
                    </ul>				
				</div>
			</div>

			<div class="row align-center copyright">
					<div class="col-sm-12"><p>Copyright &copy; 2014 Salada</p></div>
			</div>
		</div>
        ...
        <script type="text/javascript">
            ...
            function init() {
                ...
                var mapOptions = {
                    ...
                    center: new google.maps.LatLng(39.65, 2.65), // Mallorca
             ...
             function cercaPlatja() {
             	debugger;
             	s = "<p>Hola, vols cercar "+ $('#form-cerca').val() +"</p>";
             	$("#section-contact").html(s);
             }
        </script>
	</body>
</html>